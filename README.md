...
```
- `Ctrl` + `a` to select all text in the page
- `Ctrl` + `c` to copy all text in the page
- Go to [https://looi-wh.github.io/SIMConnect-Calendar-to-ICS/#convert](https://looi-wh.github.io/SIMConnect-Calendar-to-ICS/#convert)
- Paste into the field and click `Download ICS`
- ICS file will be valid for any applications such as Google Calendar and iOS Calendar
